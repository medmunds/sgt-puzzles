...
if(STRICT AND (CMAKE_C_COMPILER_ID MATCHES "GNU" OR
  ...
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wall -Wwrite-strings -Wmissing-prototypes -std=c99 -pedantic -Werror -Werror=vla")
endif()

if(STRICT AND (CMAKE_C_COMPILER_ID MATCHES "Clang"))
  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -Wmissing-variable-declarations -Werror=vla")
endif()
...
function(get_platform_puzzle_extra_source_files OUTVAR NAME AUXILIARY)
  ...
  if(build_icons AND save_file)
    ...
    build_icon(${NAME} ${save_file})
    set(c_icon_file ${CMAKE_BINARY_DIR}/icons/${NAME}-icon.c)
  elseif(EXISTS ${PUZZLES_ROOT_DIR}/icons/${NAME}-icon.c)
